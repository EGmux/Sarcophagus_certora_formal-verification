...
import "../src/contracts/libraries/Utils.sol";
...
import "../src/contracts/libraries/PrivateKeys.sol";
...
library Sarcophaguses {
   ...
   bytes32 identifier,
        ...
        uint256 indexArch = FindArch(archaeologist, data);
        Types.Archaeologist memory arch = data.archaeologists[indexArch].archaeologist;
        ...
        data.archaeologists[indexArch].archaeologistSarcophaguses.push(identifier);
        // adapter
        uint256 indexRecipient = FindRecipient(recipientAddress, data);
        data.recipients[indexRecipient].recipientSarcophaguses.push(identifier);
    ...
    function updateSarcophagus(
        ...
        //adapter
        uint256 indexArch = FindArch(sarc.archaeologist, data);
        Types.Archaeologist storage arch =
            data.archaeologists[indexArch].archaeologist;
    ...
    function cancelSarcophagus(
        ...
        // archaeologist
        data.archaeologists[indexArch].archaeologistCancel.push(identifier);
    ...
    function unwrapSarcophagus(
        ...
        // adapted
        data.archaeologists[indexArch].archaeologistSuccess.push(identifier);
    ...
    function accuseArchaeologist(
        ...
        // adapter
        uint256 indexArch = FindArch(sarc.archaeologist, data);
        data.archaeologists[indexArch].archaeologistAccusal.push(identifier);
    ...
    function cleanUpSarcophagus(
        ...
        // adapter
        uint256 indexArch = FindArch(sarc.archaeologist, data);
        data.archaeologists[indexArch].archaeologistCleanup.push(identifier);
